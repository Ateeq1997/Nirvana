...
import { Link } from "wouter"; // ✅ FIXED — use from wouter
    ...
    >
      {index === 0 && (
        <img
          ...
          alt="icon"
          className="absolute top-2 right-4 w-14 h-14"
        />
      )}
...
>
  <Button className="h-auto px-8 py-[15px] bg-[#111111] rounded-[200px] [font-family:'Poppins',Helvetica] font-semibold text-white text-[22px] tracking-[0] leading-[normal] w-full transition-all duration-300">
    See Full Dashboard
  </Button>
</motion.div>
