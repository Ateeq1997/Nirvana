    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          ...
          alt="Background"
          src="/figmaAssets/2150659027 1.jpg"
        />
      </div>

      {/* Content */}
      <div className="relative z-10 flex flex-col items-center px-4 sm:px-6 md:px-4">
        <div
          className="
            relative 
            w-full sm:w-[90%] md:w-[917px] 
            ...
            before:content-[''] before:absolute before:inset-0 before:p-[5px]
            before:rounded-[30px]
        ...
        >
          ...
          <h1
            className="
              ...
              text-3xl sm:text-5xl md:text-[85px] 
              text-center tracking-[0] 
              leading-[40px] sm:leading-[60px] md:leading-[94.4px] 
          ...
          <p
            className="
              [font-family:'Poppins',Helvetica] font-medium text-white 
            ...
            >
              <Button
                className="
                  ...
                  text-[#111111] text-lg sm:text-xl md:text-[22px]
